...
int main(void)
{
  ...
  MX_FATFS_Init();
  /* USER CODE BEGIN 2 */
  //HAL_GPIO_WritePIN(GPIOD, Accel_LED_Pin, GPIO_PIN_RESET);
  ...
  //SD_READ_FILE(nomeArquivo, infoLida);

  //SD_Find_Directories(infoLida);

  //SD_Create_Directory("nome");
  //SD_READ_FILE("ado");
  //SD_Write_File("teste1.txt", "Deuruimfam");
